...
/**
    ...
    {
        $this->assertEquals("[".$this->personne->getNom().",".$this->personne->getPrenom().","
        .$this->personne->getDatenaiss()->format('d/m/Y').",".
        $this->personne->getTelephone().",".$this->personne->getEmail().",".$this->personne->getLogin().","
        .$this->personne->getPwd()."]", $this->personne->__toString());
    }
}
