...
class PersonneDBTest extends TestCase
{
    ...
    public function testAjout()
    {
        try {
            ...
            $p = new Personne("Hollande", "Francois", $dt, "0656463524", new Adresse(3,4,"rue de saint honoré",44000,"Nantes",1), "fhollande@free.fr", "fhollande", "monpwd");
            $p->setPwd("monpwd");
            //insertion en bdd 
    ...
    public function testSelectionNom()
    {
        ...
        $p = new Personne("Valjean", "jean", $dt, "0712233445", new Adresse(3,4,"rue de saint honoré",44000,"Nantes",1), "jvaljean@free.fr", "jvaljean", "cosette");
        $p->setPwd("cosette");
        $this->personne->ajout($p);
    ...
    public function testUpdate()
    {
        ...
        $p = new Personne("Martin", "Eric", $dt, "0102030405", new Adresse(3,4,"rue de saint honoré",44000,"Nantes",1), "meric@orange.fr", "meric", "4755edd32703675c6a021322f9ca0433");
        //update pers 
