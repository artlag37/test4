...
class PersonneTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->personne = new Personne("Hollande", "Francois",$dt,"0656463524", new Adresse(3,4,"rue de saint honoré",44000,"Nantes"), "fhollande@free.fr", "fhollande", "monpwd");
...
/**
    ...
    {
        $this->assertEquals("[".$this->personne->getNom().",".$this->personne->getPrenom().",".$this->personne->getDatenaissance()->format('Y-m-d').",".$this->personne->getTelephone().",".$this->personne->getAdresse().",".$this->personne->getEmail().",".$this->personne->getLogin().",".$this->personne->getPwd()."]", $this->personne->__toString());
